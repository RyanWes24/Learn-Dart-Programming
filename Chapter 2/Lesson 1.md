...
မြင်ယောင်ကြည့်ကြည့်‌ပေးပါ။  Variable တစ်ခုဟာ နာမည် (Label) တပ်ထားတဲ့ သေတ္တာလေး တစ်ခုနဲ့ တူပါတယ်။  သေတ္တာထဲမှာ ပစ္စည်းတွေ ထည့်သိမ်းထားသလိုပဲ Variables ထဲမှာ Data တွေကို ထည့်သိမ်းထားလို့ရပါတယ်။  Variables တွေကို အသုံးပြုပြီး Data တွေကို Program တစ်ခုလုံးမှာ လိုအပ်တဲ့နေရာတိုင်းမှာ ပြန်လည် အသုံးပြုနိုင်ပါတယ်။ ပြီးတော့ Variables ထဲမှာ သိမ်းထားတဲ့ Data တွေကို Program Run နေချိန်မှာ ပြောင်းလဲလို့လည်း ရပါတယ်။
